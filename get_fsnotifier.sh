...
if [ ! -f fsnotifier-linux ]; then
  curl https://raw.githubusercontent.com/JetBrains/intellij-community/master/bin/linux/amd4/fsnotifier -o fsnotifier-linux -f || \
...
if [ ! -f fsnotifier-linux-aarch64 ]; then
  curl https://raw.githubusercontent.com/JetBrains/intellij-community/master/bin/linux/aarch64/fsnotifier -o fsnotifier-linux-aarch64 -f || \
