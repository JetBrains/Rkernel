...
namespace devices {
  ...
  private:
    ...
    pGEDevDesc slaveDevice;

    std::string buildResolutionString();
    std::string buildInitializationCommand();
    pGEDevDesc initializeSlaveDevice();
